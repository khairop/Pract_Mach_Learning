...
The random forest algorithm generates a model with accuracy 0.9922.  The top 4 most important variables are roll_bell, yaw_belt, pitch_forearm and pitch_belt. 
...
```{r}
testing_pred <- predict(rfit, newdata=testing_col)
